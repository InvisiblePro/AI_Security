...
while True:
    ...
    converted_image = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY) # converts all images in Grayscale format
    faces = detector.detectMultiScale(converted_image, 1.3, 5) # detects face with help of .xml file
